...
description: "Internal disciplinary framework applicable to CosmixMC Network Staff members."
icon: "gavel"
---

This section regulates the **internal disciplinary framework** applicable to all CosmixMC Network Staff members, with the objective of ensuring compliance with regulations, maintaining internal order, and protecting the integrity of the project.
