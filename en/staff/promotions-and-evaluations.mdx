...
description: "Performance evaluation system for MotionMC Network Staff and criteria for promotions."
icon: "chart-line"
---

This section defines the **Staff performance evaluation system** for MotionMC Network, as well as the **criteria used for promotions**.
