...
description: "Normativa interna para la prevención, identificación y gestión de conflictos de interés dentro del Staff de CosmixMC Network."
icon: "triangle-exclamation"
---

Esta sección regula la **prevención, identificación y gestión de conflictos de interés** dentro del Staff de CosmixMC Network, con el objetivo de garantizar la **imparcialidad, transparencia y profesionalidad** en todas las actuaciones.
